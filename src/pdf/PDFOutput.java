...
public class PDFOutput
{
   ...
   */
  protected ArrayList<PDFXref> offsets;
  ...
  protected void close() throws IOException
  {
    ...
    ArrayList<PDFXref> block = new ArrayList<PDFXref>();        // xrefs in this block
   ...
   */
  protected void writeblock(int firstid, ArrayList<PDFXref> block) throws IOException
  {
