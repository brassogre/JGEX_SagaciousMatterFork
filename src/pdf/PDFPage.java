...
public class PDFPage extends PDFObject implements Serializable
{
   ...
   */
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4914830614313743561L;
     ...
     */
    protected ArrayList<PDFObject> contents;
     ...
     */
    protected ArrayList<PDFObject> annotations;
     ...
     */
    protected ArrayList<PDFFont> fonts;
...
//    protected Vector xobjects;
    ...
    public PDFPage()
    {
        ...
        contents        = new ArrayList<PDFObject>();
        thumbnail       = null;
        annotations     = new ArrayList<PDFObject>();
        resources       = new ArrayList<String>();
	// JM
        imageResources	= new ArrayList<String>();
        fonts           = new ArrayList<PDFFont>();
        procset         = null;
    }
    ...
    private ArrayList<String> xobjects = new ArrayList<String>();
...
//        }
    ...
    public class procset extends PDFObject {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -5385330938480218084L;
