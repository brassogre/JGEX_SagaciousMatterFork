...
public abstract class PDFObject implements Serializable
{
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -4084622287401012088L;
...
/**
   ...
   * @exception IOException on error
   */
  public final static void writeEnd(OutputStream os) throws IOException
  {
    os.write(">>\nendobj\n".getBytes());
  }
   ...
   */
  public static String toArray(ArrayList<? extends PDFObject> v)
  {
