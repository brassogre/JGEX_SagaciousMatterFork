...
//        RValue[R_RATIO - 1] = false;
    ...
    final int SPT(String s) {
        ...
        for (int i = 1; allpts[i] != null; i++) {
            if (s.equals(allpts[i].getName()))
            	return i;
        }
        return 0;
    }
...
//        }
    ...
    final static xterm P1(int p) {
    	// This method is called during application of the Full Area proof technique, but the implementation has not been completed yet.
    	return null; // TODO: Not sure what this is supposed to be doing...
    }

    final static xterm P2(int p) {
    	// This method is called during application of the Full Area proof technique, but the implementation has not been completed yet.
        return null; // TODO: Not sure what this is supposed to be doing...
    }
    ...
    final public void show_agll(l_line ln1, l_line ln2) {  // overridden.
    ...
    final public static void exit(int v) {
        Cm.print("System exit: " + v);
        System.exit(v);
    }

    final public static void gerror(String s) {
        Cm.print("Error: " + s);
        System.exit(0);
    }

    final static int inter_lls(l_line l1, l_line l2) {
        int i, j;
    ...
    final static int get_lpt1(l_line l1, int p1) {
        char j;
        for (j = 0; j <= l1.no; j++) {
    ...
    final static int get_lpt2(l_line l1, int p1, int p2) {
        char j;
        for (j = 0; j <= l1.no; j++) {
    ...
    final public static cond getDefaultCond(cclass cc) {
        cond co = new cond();
        co.pred = 0;
    ...
    public static boolean ck_4peq(int p1, int p2, int p3, int p4) {
    ...
    final public static boolean same_tri(int p1, int p2, int p3, int q1, int q2, int q3) {
        if (
    ...
    public void collect_angst() {
        ...
        angles as = all_as.nx;
        ArrayList<angles> vt = new ArrayList<angles>();
        while (as != null) {
