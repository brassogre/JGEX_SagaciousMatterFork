...
public class Prover {
    ...
    public static boolean fixpoint(gterm gt) {
        try {
            ...
            System.out.println("Exception generated in gprover.Prover: \n" + e.getMessage());
            return false;
        }
        return true;
    }
    ...
    public static ArrayList<cclass> search_a_fact(int t, String s1, String s2, String s3) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static boolean getAllNdgs(gterm gt, ArrayList<cons> v1, ArrayList<cndg> v2, ArrayList<cndg> v3, ArrayList<cndg> v4) {
        try {
            Prover.gt = gt;
            if (dbfull == null)
                dbfull = new Full();
...
//    public static gr_term proveArea(ArrayList v) {
//        return null;
//    }
