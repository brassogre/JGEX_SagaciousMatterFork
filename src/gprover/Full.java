...
// This class implements the Full Area method for proving hypotheses.
...
public class Full extends elim {
		...
		do {
			...
			while (true) {
				if ((e1 = elim_q7(p1)) != null) {
						...
						&& ((e1 = elim_d(p1.var)) != null)) {
				} else if (((fcc(p1) % 3L) == 0)
						&& ((e1 = elim_t(p1.var)) != null)) {
				...
				if (e1 != null) {
					...
					while (e != null) {
						final int tn = p1.getTermNumber();
						p1 = eprem(cp_poly(p1), e);
						p1 = fpoly(p1);
						if (max_termp) {
							final int tem = plength(p1);
							if (tem > max_term)
								max_term = tem;
						}
						gr1 = mk_gr(mk_num(1L), get_dt(1, p1, null),
								mk_num(0L), null, 99, null);
						gr1.setPTN(tn);
						gr1.el = e;
						e = e.nx;
						gr1.el.nx = null;
	...
	void conc_gr(long c1, xterm p1, long c2, xterm p2) {
		...
		final gr_term gr = mk_gr1((int) mk_num(c1), p1, (int) mk_num(c2), p2);
		gr.c = 0;
		last_pr.nx = gr;
		last_pr = gr;
	}
	...
	void fconc(cond conc) {
		...
		case CO_PARA:
			/* parallel */
			conc_gr(1L, trim_full(conc.p[0], conc.p[1], conc.p[2], conc.p[3]),
					0L, null);
			break;
		case CO_PERP:
			/* perpendicular */
			conc_gr(1L,
					pplus(trim_full(conc.p[0], conc.p[1], conc.p[2], conc.p[3]),
							get_n(1L)), 0L, null);
			break;
		case CO_ACONG:
			/* eqangle */
			conc_gr(1L,
					pminus(trim_f(conc.p[0], conc.p[1], conc.p[2], conc.p[3]),
							trim_f(conc.p[4], conc.p[5], conc.p[6], conc.p[7])),
					0L, null);
			break;
		case CO_CYCLIC:
			/* cocircle */
			conc_gr(1L,
					pminus(trim_f(conc.p[3], conc.p[1], conc.p[3], conc.p[2]),
		...
		case -12:
			/* perp-b */
			conc_gr(1L,
					pminus(trim_f(conc.p[0], conc.p[1], conc.p[1], conc.p[2]),
	...
	el_term mk_felim(var v, xterm p1, xterm p2, int n, int t) {
		final el_term e = mk_felim(v, p1, p2, t);
		if (n != 1)
	...
	el_term mk_felim(var v, xterm p1, xterm p2, int t) {
		final el_term el = mk_felim(v, p1, p2);
		el.etype = t;
		return el;
	}
	...
	el_term elim_qcs(xterm p) { // NO USAGE.
		final var v1 = p.var;
		final l_line ln1 = fadd_ln(v1.pt[0], v1.pt[1]);
		final l_line ln2 = fadd_ln(v1.pt[2], v1.pt[3]);
		...
		if ((ln1.pt[0] < v1.pt[0]) && (ln1.pt[1] < v1.pt[0])) {
			add_codb(CO_COLL, ln1.pt[0], ln1.pt[1], v1.pt[0], v1.pt[1], 0, 0,
					0, 0);
			p1 = ln1.pt[0];
			p2 = ln1.pt[1];
			t = true;
		...
		if ((ln2.pt[0] < v1.pt[2]) && (ln2.pt[1] < v1.pt[2])) {
			add_codb(CO_COLL, ln2.pt[0], ln2.pt[1], v1.pt[2], v1.pt[3], 0, 0,
					0, 0);
			p3 = ln2.pt[0];
			p4 = ln2.pt[1];
			t = true;
			...
			while (ps2 != null) {
				...
				if (fcc(p1) == fcc(p2)) {
					if ((ln2 == ln3) && ln_less(ln4, ln2)) {
						co_db.nx = null;
						add_codb(CO_COLL, v1.pt[2], v1.pt[3], v2.pt[0],
								v2.pt[1], 0, 0, 0, 0);
						final xterm xt = trim_f(v1.pt[0], v1.pt[1], v2.pt[2],
								v2.pt[3]);
						int r = RF_ADDITION;
						if (pzerop(xt))
							r = 2;
						return (mk_felim(p1.var, pminus(xt, get_m(p2.var)),
								get_n(1L), r));
					}
					if (ln1 == ln4) {
						co_db.nx = null;
						add_codb(CO_COLL, v1.pt[0], v1.pt[1], v2.pt[2],
								v2.pt[3], 0, 0, 0, 0);
						final xterm xt = trim_f(v2.pt[0], v2.pt[1], v1.pt[2],
								v1.pt[3]);
						int r = RF_ADDITION;
						if (pzerop(xt))
							r = 2;
					...
					if ((ln1 == ln3) && (ln2 == ln4)) {
						co_db.nx = null;
						add_codb(CO_COLL, v1.pt[0], v1.pt[1], v2.pt[0],
								v2.pt[1], 0, 0, 0, 0);
						add_codb(CO_COLL, v1.pt[2], v1.pt[3], v2.pt[2],
								v2.pt[3], 0, 0, 0, 0);
					...
					if ((ln2 == ln4) && ln_less(ln3, ln2)) {
						...
						add_codb(CO_COLL, v1.pt[2], v1.pt[3], v2.pt[2],
								v2.pt[3], 0, 0, 0, 0);
						final xterm xt = trim_f(v1.pt[0], v1.pt[1], v2.pt[0],
								v2.pt[1]);
						int r = RF_ADDITION;
						if (pzerop(xt))
							r = 1;
						return (mk_felim(p1.var, pplus(get_m(p2.var), xt),
								get_n(1L), r));
					}
					...
					if (ln1 == ln3) {
						...
						add_codb(CO_COLL, v1.pt[0], v1.pt[1], v2.pt[0],
								v2.pt[1], 0, 0, 0, 0);
						final xterm xt = trim_f(v2.pt[2], v2.pt[3], v1.pt[2],
								v1.pt[3]);
						int r = RF_ADDITION;
						if (pzerop(xt))
							r = 1;
	...
	el_term elim_q8(xterm p1) {
		...
		{
			co_db.nx = null;
			add_codb(CO_COLL, v1.pt[0], v1.pt[1], v2.pt[0], v2.pt[1], 0, 0, 0,
					0);
			return (mk_felim(
					p1.var,
					pplus(get_m(p2.var),
							trim_f(v2.pt[2], v2.pt[3], v1.pt[2], v1.pt[3])),
					get_n(1L), RF_ADDITION)); // addition.
		}
	}
	...
	el_term mk_felim11(var v, int a, int b, int c, int d, int o, int p1,
			int p2, int o1) { // <[ab, cd] = <[o1p1,o1,p2]
	// co_db.nx = null;
	//
	...
	// el_term e2 = mk_felim(new var(10, o, p1, o, p2), trim_f(o1, p1, o1, p2),
	// get_n(1), 9);
	// e1.nx = e2;
	// co_db.nx = null;
	// } else {
	...
	// return el;
		...
		add_codb(CO_CYCLIC, 0, o, o1, p1, p2, 0, 0, 0);
		add_codb(CO_COLL, o, p1, a, b, 0, 0, 0, 0);
		add_codb(CO_COLL, o, p2, c, d, 0, 0, 0, 0);

		// el_term e1 = null;
		// if (c1.pred != 0 || c2.pred != 0) {
		// e1 = mk_felim(v, trim_f(o, p1, o, p2), get_n(1L), 0);
		// co_db.nx = null;
		// el_term e2 = mk_felim(new var(10, o, p1, o, p2), trim_f(o1, p1, o1,
		// p2), get_n(1), 9);
		// e1.nx = e2;
		// co_db.nx = null;
		// } else {
		// add_codb(CO_CYCLIC, 0, o, o1, p1, p2, 0, 0, 0);
		// }
		final el_term el = (mk_felim(v, trim_f(o1, p1, o1, p2), get_n(1L),
				RF_INSCRIBE));
		co_db.nx = null;
	...
	el_term mk_felim6(var v, int a, int b, int c, int d) { // para
		...
		final el_term e1 = mk_felim(v, get_n(0L), get_n(1L), 3);
		return e1;
	}
	...
	el_term elim_f_ln(var v, int a, int b, int c, int d) {
		...
		final l_line ln1 = fd_ln(a, b);
		if ((ln1 != null) && (a > ln1.pt[1])) {
			co_db.nx = null;
			add_codb(CO_COLL, ln1.pt[0], ln1.pt[1], a, b, 0, 0, 0, 0);
			return (mk_felim(v, trim_f(ln1.pt[0], ln1.pt[1], c, d), get_n(1L),
					1));
		}
		return (null);
	}
	...
	el_term elim_f_pn(var v, int a, int b, int c, int d) {
		...
		final l_line ln1 = fd_ln(a, b);
		final p_line pn1 = fd_pn(a, b);
		if (pn1 == null)
			return (null);
		for (int i = 0; i <= pn1.no; i++) {
			final l_line ln2 = pn1.ln[i];
			if (ln_less(ln2, ln1)) {
				co_db.nx = null;
				add_codb(CO_PARA, a, b, ln2.pt[0], ln2.pt[1], 0, 0, 0, 0);
				final var v1 = new var(10, a, b, ln2.pt[0], ln2.pt[1]);
				final el_term e1 = mk_felim6(v1, a, b, ln2.pt[0], ln2.pt[1]);
				co_db.nx = null;
				final el_term e = (mk_felim(v,
						trim_f(ln2.pt[0], ln2.pt[1], c, d), get_n(1L), 1));
				e.et = e1;
				return e;
			}
		}
	...
	el_term elim_f_tn(var v, int a, int b, int c, int d) // could be more tn
															// lines.
	{
		l_line ln2;
		...
		if (tn1 != null) {
			...
			if (ln_less(ln2, ln1)) {
				co_db.nx = null;
				final el_term e1 = mk_felim(
						v,
						pplus(trim_f(a, b, ln2.pt[0], ln2.pt[1]),
								trim_f(ln2.pt[0], ln2.pt[1], c, d)), get_n(1L),
						RF_ADDITION);
				add_codb(CO_PERP, a, b, ln2.pt[0], ln2.pt[1], 0, 0, 0, 0);
				final var v1 = new var(10, a, b, ln2.pt[0], ln2.pt[1]);
				final el_term e2 = mk_felim7(v1, a, b, ln2.pt[0], ln2.pt[1]);
				e1.nx = e2;
				co_db.nx = null;
				final el_term e = (mk_felim(v,
						pplus(trim_f(ln2.pt[0], ln2.pt[1], c, d), get_n(1L)),
						get_n(1L), RF_PERP_SPLIT));
				e.et = e1;
				return e;
			}
		} else if (a == c) {
			...
			if (tn1 != null) {
				...
				if (ln_less(ln2, ln1)) {
					...
					final el_term e1 = mk_felim(
							v,
							pplus(trim_f(a, b, ln2.pt[0], ln2.pt[1]),
									trim_f(ln2.pt[0], ln2.pt[1], c, d)),
							get_n(1L), RF_ADDITION);
					add_codb(CO_PERP, c, d, ln2.pt[0], ln2.pt[1], 0, 0, 0, 0);
					final var v1 = new var(10, c, d, ln2.pt[0], ln2.pt[1]);
					final el_term e2 = mk_felim7(v1, c, d, ln2.pt[0], ln2.pt[1]);
					e1.nx = e2;
					co_db.nx = null;
					final el_term e = (mk_felim(
							v,
							pplus(trim_f(a, b, ln2.pt[0], ln2.pt[1]), get_n(1L)),
							get_n(1L), RF_PERP_SPLIT));
					e.et = e1;
					return e;
				}
	...
	el_term elim_f_cir1(var v, int a, int b, int c, int d) {
		...
		final l_line ln1 = fadd_ln(a, b);
		final l_line ln2 = fadd_ln(c, d);
		a_cir cr = all_cir.nx;
		while (cr != null) // R11
		{
			if (cr.type == 0) {
			...
			for (int i = 0; i < cr.no; i++)
				for (int j = 0; j <= cr.no; j++) {
					...
					if ((p3 != p1) && (p3 != p2) && (p4 != p1) && (p4 != p2)) {
						...
						ln4 = fadd_ln(p3, p4);
						ln5 = fadd_ln(p4, p2);
						final int tp1 = inter_ll(ln1, ln5);
						final int tp2 = inter_ll(ln2, ln5);

						if (ln_less(ln3, ln1) && ln_less(ln4, ln1)
								&& ln_less(ln5, ln1))// R12.
						{
							final el_term e1 = mk_felim(
									v,
									pplus(trim_f(a, b, p2, p4),
											trim_f(p2, p4, c, d)), get_n(1L),
									RF_ADDITION);
							final var v1 = new var(10, a, b, p2, p4);
							final el_term e2 = mk_felim11(v1, a, b, p2, p4, p2,
									p1, p4, p3);
							e1.nx = e2;
							co_db.nx = null;
							final el_term el = (mk_felim(
									v,
									pplus(trim_f(p3, p1, p3, p4),
											trim_f(p4, p2, c, d)), get_n(1L),
									RF_9));
							el.et = e1;
							if ((tp1 != 0) && (tp2 != 0))
								return el;
								...
								if (ln_para(ln6, ln5) && ln_less(ln6, ln1)) {
									final el_term e1 = mk_felim(
											...
											pplus(trim_f(a, b, p2, p4),
													trim_f(p2, p4, c, d)),
											get_n(1L), RF_ADDITION);
									final var v2 = new var(10, a, b, p2, p4);
									final el_term e2 = mk_felim11(v2, a, b, p2,
											p4, p2, p1, p4, p3);
									co_db.nx = null;
									final var v3 = new var(10, p4, p2,
											ln6.pt[0], ln6.pt[1]);
									final el_term e3 = mk_felim6(v3, p4, p2,
											ln6.pt[0], ln6.pt[1]);
									e1.nx = e2;
									e2.nx = e3;
									co_db.nx = null;
							...
							while (ln6 != null) {
								if (ln_perp(ln6, ln5) && ln_less(ln6, ln1)) {
									...
									final var v3 = new var(10, p4, p2,
											ln6.pt[0], ln6.pt[1]);
									final el_term e3 = mk_felim7(v3, p4, p2,
											ln6.pt[0], ln6.pt[1]);
									e1.nx = e2;
									e2.nx = e3;
									co_db.nx = null;
				...
				for (int i = 0; i <= cr1.no; i++)
					for (int j = 0; j <= cr2.no; j++)
						if ((cr1.pt[i] != o)
								...
								&& (cr2.pt[j] != o)
								&& (cr2.pt[j] != p2)
								&& xcoll(o, cr1.pt[i], cr2.pt[j])
								&& ((p3 = get_cpt3(cr1, o, p1, cr1.pt[i])) != 0)
								&& ((p4 = get_cpt3(cr2, o, p2, cr2.pt[j])) != 0)) {
							ln3 = fadd_ln(p3, p1);
							ln4 = fadd_ln(p3, cr1.pt[i]);
							ln5 = fadd_ln(p4, p2);
							ln6 = fadd_ln(p4, cr2.pt[j]);
							if (l2_less(ln3, ln4, ln1, ln2)
									&& l2_less(ln5, ln6, ln1, ln2)) {
								co_db.nx = null;
								add_codb(CO_CYCLIC, 0, o, p2, cr2.pt[j], p4, 0,
										0, 0);
								add_codb(CO_CYCLIC, 0, o, p1, cr1.pt[i], p3, 0,
										0, 0);
								add_codb(CO_COLL, o, cr1.pt[i], cr2.pt[j], 0,
										0, 0, 0, 0);
								return (mk_felim(
										v,
										pminus(trim_f(p3, p1, p3, cr1.pt[i]),
												trim_f(p4, p2, p4, cr2.pt[j])),
										get_n(1L), RF_12));
							}
						}
				cr2 = cr2.nx;
		...
		for (cr1 = all_cir.nx; cr1 != null; cr1 = cr1.nx) {
			...
			if (o == inter_ll(ln1, ln2)) {
				...
				if (p2 != 0) {
					for (i = 0; i <= cr1.no; i++) {
						...
						if ((p3 != p1) && (p3 != p2)
							...
							return (mk_felim(v,
									ptimes(get_n(2L), trim_f(p3, p1, p3, p2)),
									get_n(1L), RF_13)); // R23
						}
					}
					ln3 = fadd_ln(p1, p2);
					if (ln_less(ln3, ln1)) {
						...
						return (mk_felim(v,
								ptimes(get_n(2L), trim_f(p1, p2, c, d)),
								get_n(1L), RF_14)); // r24
					}
				}
				...
				if ((p2 != 0) && ln_less(fadd_ln(o, p2), ln1)) {
					...
					return (mk_felim(v, trim_f(p1, p2, o, p2), get_n(1L),
							RF_ISO));
				}
			}
			for (i = 0; i < cr1.no; i++)
				for (j = i + 1; j <= cr1.no; j++) {
					...
					if ((p2 != p1) && (p3 != p1)) {
						...
						ln3 = fadd_ln(p3, p1);
						ln4 = fadd_ln(p3, p2);
						if (ln_less(ln2, ln1) && ln_less(ln3, ln1)
								&& ln_less(ln4, ln1)) {
							co_db.nx = null;
							add_codb(CO_CYCLIC, o, p1, p2, p3, 0, 0, 0, 0);
							return (mk_felim(
									v,
									pplus3(trim_f(p3, p1, p3, p2),
											trim_f(ln2.pt[0], ln2.pt[1], c, d),
											get_n(1L)), get_n(1L), RF_16));
						}
					}
				}
		}
			...
			for (int i = 0; i <= cr1.no; i++)
				if ((cr1.pt[i] != p1) && (cr1.pt[i] != p2)) {
					...
					if ((p4 != 0) && (o != p4)
						...
						return (mk_felim(
								v,
								pplus(trim_f(o, p1, o, p4),
										trim_f(p2, p3, c, d)), get_n(1L), RF_17)); // r27
					}
					if ((p4 != 0) && (o != p4)
						...
						return (mk_felim(
								v,
								pplus(trim_f(o, p4, o, p3),
										trim_f(p2, p3, c, d)), get_n(1L), RF_17));
					}
					if (ln_less((fadd_ln(p1, o)), ln1)
						...
						return (mk_felim(
								v,
								pplus3(trim_f(p1, o, p1, p3),
										trim_f(p2, p3, c, d), get_n(1L)), // r28
								get_n(1L), RF_18));
					}
					if (ln_less((fadd_ln(p3, o)), ln1)
						...
						return (mk_felim(
								v,
								pplus3(trim_f(p3, p1, p3, o),
										trim_f(p2, p3, c, d), get_n(1L)),
								get_n(1L), RF_18));
					}
				}
			cr1 = cr1.nx;
				...
				for (k = 1; k <= cons_no; k++)
					for (l = 1; l <= cons_no; l++) {
						...
						if ((k < l) && (p1 < p2) && (k != p1) && (k != p2)
							...
							return (mk_felim(v,
									pplus(trim_f(k, l, c, d), get_n(1L)),
									get_n(1L), RF_ORTH));
						}

						/* incenter (p1) p2 k l */
						/*
						 * gprint("cen1: %s %s %s %s\r\n",ANAME(p1),ANAME(p2),ANAME
						 * (k),ANAME(l));
						 */
						if ((k < l) && (k != p1) && (k != p2) && (l != p1)
								&& (l != p2) && xacong(k, l, p1, p1, l, p2)
								&& xacong(l, k, p1, p1, k, p2)
							...
							return (mk_felim(
									v,
									pplus4(trim_f(k, l, k, p1),
											trim_f(l, p1, l, k),
											trim_f(p2, k, c, d), get_n(1L)),
									get_n(1L), RF_20));
						}
					}
				k = 1;
	...
	el_term elim_f_ans(var v, int a, int b, int c, int d) {
		...
		for (as = all_as.nx; as != null; as = as.nx) {
			...
			if (ln_less(ln1, l1) && ln_less(ln2, l1)) {
				co_db.nx = null;
				add_codb(CO_ACONG, a, b, c, d, ln1.pt[0], ln1.pt[1], ln2.pt[0],
						ln2.pt[1]);
				return (mk_felim(v, trim_fl(ln1, ln2), get_n(1L), RF_21));
			}
		}
		for (as = all_as.nx; as != null; as = as.nx) {
			if ((l1 == as.l1) && ln_less(as.l2, l1) && ln_less(as.l3, l1)
					&& ln_less(as.l4, l1)) {
				ln0 = as.l2;
				ln1 = as.l3;
				ln2 = as.l4;
			} else if ((l1 == as.l2) && ln_less(as.l1, l1)
					&& ln_less(as.l3, l1) && ln_less(as.l4, l1)) {
				ln0 = as.l1;
				ln1 = as.l4;
				ln2 = as.l3;
			} else if ((l1 == as.l3) && ln_less(as.l1, l1)
					&& ln_less(as.l2, l1) && ln_less(as.l4, l1)) {
				ln0 = as.l4;
				ln1 = as.l1;
				ln2 = as.l2;
			} else if ((l1 == as.l4) && ln_less(as.l1, l1)
					&& ln_less(as.l2, l1) && ln_less(as.l3, l1)) {
				ln0 = as.l3;
				ln1 = as.l2;
				ln2 = as.l1;
			} else
			...
			co_db.nx = null;
			add_codb(CO_ACONG, a, b, ln0.pt[0], ln0.pt[1], ln1.pt[0],
					ln1.pt[1], ln2.pt[0], ln2.pt[1]);
			return (mk_felim(v, pplus(trim_fl(ln0, l2), trim_fl(ln1, ln2)),
					get_n(1L), 0)); // ?????
		}
		return (null);
	}
	...
	el_term elim_d(var v) {
		...
		while (cr != null) {
			...
			p1 = inter_lc(ln1, cr);
			if ((p1 != 0) && on_ln(o, ln1)) {
				if (on_ln(p1, ln2) && ((p2 = inter_lc1(ln2, cr, p1)) != 0)
						&& xperp(o, p1, o, p2)) {
					co_db.nx = null;
				...
				for (int i = 0; i <= cr.no; i++) {
					...
					if (xperp(o, p1, o, p2) && ln_less(fadd_ln(p1, p2), ln1)) {
						...
						return (mk_felim(
								v,
								pplus(ptimes(get_n(2L), trim_f(p1, p2, c, d)),
										get_n(1L)), get_n(2L), RF_TT));
					}
				}
			}
			...
			p1 = inter_lc(ln1, cr);
			p2 = inter_lc1(ln1, cr, p1);
			if ((p1 != 0) && (p2 != 0) && ln_less(fadd_ln(o, p1), ln1)
					&& ln_less(fadd_ln(o, p2), ln1))
				if (xpara(o, p1, c, d)) {
					co_db.nx = null;
				...
				for (int i = 0; i <= cr1.no; i++) {
					...
					if ((p5 != p1) && (p5 != p2)
						...
						if (p4 == p1) {
							...
							add_codb(CO_COLL, o, a, b, p3, 0, 0, 0, 0);
							add_codb(CO_COLL, c, d, p1, 0, 0, 0, 0, 0);
							return (mk_felim(v, trim_f(p5, p2, p5, p1),
									get_n(2L), RF_DM2));
						} else if (p4 == p2) {
							co_db.nx = null;
							add_codb(CO_CYCLIC, 0, o, p1, p2, p3, p5, 0, 0);
							...
							add_codb(CO_COLL, o, a, b, p3, 0, 0, 0, 0);
							add_codb(CO_COLL, c, d, p2, 0, 0, 0, 0, 0);
							return (mk_felim(v, trim_f(p5, p1, p5, p2),
									get_n(2L), RF_DM2));
						}
						/* check here */
			...
			if (as.type != 0) {
				...
				if (((ln1 == l1) && (ln2 == l2))
					...
					if ((l2 == l3) && ln_less(l1, l2) && ln_less(l4, l3)) {
						add_codb(CO_ACONG, l1.pt[0], l1.pt[1], l2.pt[0],
								l2.pt[1], l3.pt[0], l3.pt[1], l4.pt[0],
								l4.pt[1]);
						return mk_felim(v,
								trim_f(l1.pt[0], l1.pt[1], l4.pt[0], l4.pt[1]),
								get_n(2L), 2, 0);
						...
						add_codb(CO_ACONG, l1.pt[0], l1.pt[1], l2.pt[0],
								...
								l4.pt[1]);
						return mk_felim(v,
								trim_f(l3.pt[0], l3.pt[1], l2.pt[0], l2.pt[1]),
								get_n(2L), 2, 0);
					}
			}
			as = as.nx;
	...
	el_term elim_t(var v) {
		...
		for (as = all_as.nx; as != null; as = as.nx)
			if ((as.sa == 60) && (onl_as(ln1, ln2, as) || onl_as(ln2, ln1, as))) {
				co_db.nx = null;
				add_codb(-(CO_ACONG), 60, v.pt[0], v.pt[1], v.pt[2], v.pt[3],
						0, 0, 0);
	...
	el_term elim_tri(var v) {
		final l_line ln1 = fadd_ln(v.pt[0], v.pt[1]);
		final l_line ln2 = fadd_ln(v.pt[2], v.pt[3]);

		final int o = inter_lls(ln1, ln2);
		if (o != 0)
			for (int i = 0; i <= ln1.no; i++)
				for (int j = 0; j <= ln2.no; j++)
					if ((ln1.pt[i] != o) && (ln2.pt[j] != o))
						if (xcong(o, ln1.pt[i], ln1.pt[i], ln2.pt[j])
								&& xperp(o, ln1.pt[i], ln1.pt[i], ln2.pt[j])) {
							add_codb(CO_PERP, o, ln1.pt[i], ln1.pt[i],
									ln2.pt[j], 0, 0, 0, 0);
							add_codb(CO_CONG, o, ln1.pt[i], ln1.pt[i],
									ln2.pt[j], 0, 0, 0, 0);
							return mk_felim(v, get_n(1), get_n(2), 2, 0);
						} else if (xcong(o, ln2.pt[j], ln2.pt[j], ln1.pt[i])
								&& xperp(o, ln2.pt[j], ln2.pt[j], ln1.pt[i])) {
							add_codb(CO_PERP, o, ln2.pt[j], ln2.pt[j],
									ln1.pt[i], 0, 0, 0, 0);
							add_codb(CO_CONG, o, ln2.pt[j], ln2.pt[j],
									ln1.pt[i], 0, 0, 0, 0);
							return mk_felim(v, get_n(1), get_n(2), 2, 0);
						}
		return null;
	...
	public boolean isProvedTrue() {
		if ((last_pr != null) && last_pr.isZero())
			return true;
		return false;
	}
	...
	public gr_term getFullAngleProofHead() {
		...
		gr_term gt2 = proof.nx;
		if (gt2 == null)
			return null;
		while (gt2 != null) {
			if (gt2.ps1 != null)
				myprint_p1(gt2.ps1.p, true);
			el_term el = gt2.el;
			if (el != null) {
	...
	public boolean print_prooftext() // added MAY 4th 2006
	{
		...
		while (gr1 != null) {
			if (gr1.c == -1) {
				setPrintToString();
				final dterm dt = gr1.ps;
				print_ps(dt, mk);
				dt.text = getPrintedString();
			} else if (gr1.c == -2) {
			} else if (gr1.c == 0) {
			} else {
				final el_term el = gr1.el;
				print_elims(el, mk);
			}
	...
	void print_ps(dterm dp1, char mk) {
		if (dp1 == null)
			...
			while (dp1 != null) {
				if (dp1.deg == 1) {
					if ((k >= 0) && (pro_type != PRO_FULL)
							&& ((plength(dp1.p) > 1) || (lcc(dp1.p) < 0))) {
						gprint("(");
						print_p(dp1.p, mk);
						gprint(")");
					} else
	...
	public void myprint_p1(xterm p1, boolean first) {
		...
		final String s = getPrintedString();
		p1.sd = s;
	...
	xterm trim_full(int p1, int p2, int p3, int p4) {
		...
		final l_line ln1 = fd_ln(p1, p2);
		final l_line ln2 = fd_ln(p3, p4);
	...
	public void get_ndgs(ArrayList<cons> v1, ArrayList<cndg> v2,
			ArrayList<cndg> v3, ArrayList<cndg> v4) { // cndg

		final int n = cns_no;
		for (int i = 1; i <= n; i++) {
			final cons c = allcns[i];
	...
	protected cndg add_n_isotropic(int a, int b, ArrayList<cndg> v1) {
		if (a == b)
			return null;
	...
	protected cndg add_n_pt(int type, int a, int b, int c, int d,
			ArrayList<cndg> v1) {
		if (a > b) {
			final int t = a;
			a = b;
	...
	protected cndg add_n_coll(int a, int b, int c, ArrayList<cndg> v1) {
		if (a > b) {
			final int t = a;
			a = b;
			b = t;
	...
	public void init_ndgs(ArrayList<cndg> v1) {
		cndg nd;
		...
		for (int i = 1; i <= n; i++) {
			...
			case C_I_PA: {
				final cndg dx = add_n_pt(NDG_PARA, c.ps[2], c.ps[3], c.ps[4],
						c.ps[5], v1);
				if (dx != null)
					dx.exists = true;
				...
				break;
			case C_I_LA: {
				final cndg dx = add_n_coll(c.ps[0], c.ps[1], c.ps[3], v1);
				if (dx != null)
					dx.exists = true;
				...
				break;
			case C_I_AA: {
				final cndg dx = add_n_pt(NDG_PARA, c.ps[0], c.ps[1], c.ps[0],
						c.ps[6], v1);
				if (dx != null)
					dx.exists = true;
			...
			if (sz < v1.size()) {
				sz = v1.size();
				final cndg dd = v1.get(v1.size() - 1);
				dd.dep = c;
			}
		}
	}

	public void add_n_neq(int a, int b, ArrayList<cndg> v1) {
		final cndg nd = add_ndg_neq(a, b);
		add_ndgs(nd, v1);
	}

	public void add_coll_para(cons cs, ArrayList<cndg> v1) {
		int a, b;
	...
	public void angle_deduction(cndg c, ArrayList<cndg> v4) {
		if (c == null)
			return;

		if (ck_allFree(c)) { // all free Points.
			final cndg d = new cndg(c);
			v4.add(d);
			return;
		}
		...
		case NDG_NON_ISOTROPIC:
			final cndg d1 = new cndg(c);
			add_ndgs(d1, v4);
			break;
		}
	}

	protected void add_deduction(int a, int b, int c, int d, ArrayList<cndg> v4) {
		final xterm x = trim_f(a, b, c, d);
		final xterm x1 = add_deduction(x);
	...
	protected void add_neqTo(int a, int b, ArrayList<cndg> v4) {
	...
	protected void add_ndgs(cndg d, ArrayList<cndg> vlist) {
		if (d == null)
			return;
	...
	protected void addxtermndg(xterm x, ArrayList<cndg> v4) {
		if (x == null)
			return;
		xterm2ndg(x, v4);
		...
		setPrintToString();
		xprint(x);
		x.sd = getPrintedString();
	}

	protected void xterm2ndg(xterm x, ArrayList<cndg> vlist) {
		if ((x == null) || (x.var == null))
			return;

		final int n = x.getTermNumber();
	...
	protected void xterm_1term(xterm x, ArrayList<cndg> vlist) {
		final long n = fcc(x);

		if (x.var == null) {
			// /////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
		} else if (n == 1) {
			final cndg d = add_ndg_para(x.var);
			if (d != null)
				d.dep = x;
			add_ndgs(d, vlist);
		} else if (n == 2) {
			...
			final cndg d = add_ndg_triplePI(x.var);
			if (d != null)
				d.dep = x;
			add_ndgs(d, vlist);
		}
	...
	protected void xterm_2term(xterm x, ArrayList<cndg> vlist) {
		fcc(x);
		if (x.ps != null) {
			final dterm dx1 = x.ps.nx;
			if (dx1 != null) {
				final xterm x1 = dx1.p;
				final long n1 = fcc(x1);
				...
				if (v2 != null) { // v2 != null <A + <B = 0.
					if (n1 < 0) {
						if ((v1.pt[2] == v2.pt[0]) && (v1.pt[3] == v2.pt[1])) {
							cndg d = add_ndg_cong(v1.pt[0], v1.pt[1], v2.pt[2],
									v2.pt[3]);
							if (d != null) {
								d.dep = x;
								add_ndgs(d, vlist);
							}
							d = add_ndg_coll(v1.pt[0], v1.pt[1], v1.pt[3]);
							if (d != null) {
								d.dep = x;
								add_ndgs(d, vlist);
							}
						...
						if ((v1.pt[2] == v2.pt[2]) && (v1.pt[3] == v2.pt[3])) {
							cndg d = add_ndg_cong(v1.pt[0], v1.pt[1], v2.pt[0],
									v2.pt[1]);
							if (d != null) {
								d.dep = x;
								add_ndgs(d, vlist);
				...
				} else if ((x1.var == null) & (x1.c == 1)) {
					final cndg d = add_ndg_perp(v1);
					if (d != null)
						d.dep = x;
					add_ndgs(d, vlist);
				}
	...
	protected static cndg add_ndg_neq(int a, int b) {
		if (a == b)
			return null;
		final cndg n = new cndg();
		n.type = NDG_NEQ;
	...
	protected void parse_ndg_neq(int a, int b, ArrayList<cndg> v4) {
		if (a == b)
			return;
		...
		if (freeCSP(a) && freeCSP(b)) {
			...
			final xterm x = parseNEQ(a, b, v4);
			if (x != null)
				addxtermndg(x, v4);
		}
	}

	private xterm parseNEQ(int a, int b, ArrayList<cndg> v2) {

		for (int i = 0; i < v2.size(); i++) {
			final cndg n = v2.get(i);
			if ((n.type == NDG_NEQ) || (n.type == NDG_NON_ISOTROPIC)) {
				final xterm x1 = parseNEQ(a, b, n.p[0], n.p[1], v2);
				if (x1 != null)
					return x1;
	...
	private xterm parseNEQ(int a, int b, int a1, int b1, ArrayList<cndg> v2) {
		if ((a == a1) || (a == b1))
			return null;
		if ((b == a1) || (b == b1))
			return null;
	...
	public static boolean freeCS(int t) {
		return (t == 0) || (t == C_POINT) || (t == C_LINE) || (t == C_TRIANGLE)
				|| (t == C_QUADRANGLE) || (t == C_PENTAGON) || (t == C_POLYGON)
				|| (t == C_CIRCLE);
	}
	...
	protected void get_ndgstr(cndg d) {
		...
		switch (d.type) {
		case NDG_COLL:
			sd = ANAME(d.p[0]) + ", " + ANAME(d.p[1]) + ", " + ANAME(d.p[2])
					+ " are not collinear";
			break;
		case NDG_NEQ:
		...
		case NDG_NON_ISOTROPIC:
			...
			break;
		case NDG_PARA:
			sd = ANAME(d.p[0]) + ANAME(d.p[1]) + " is not parallel to "
					+ ANAME(d.p[2]) + ANAME(d.p[3]);
			break;
		case NDG_PERP:
			sd = ANAME(d.p[0]) + ANAME(d.p[1]) + " is not perpendicular to "
					+ ANAME(d.p[2]) + ANAME(d.p[3]);
			break;
		case NDG_CYCLIC:
			sd = ANAME(d.p[0]) + ", " + ANAME(d.p[1]) + ", " + ANAME(d.p[2])
					+ ", " + ANAME(d.p[3]) + " are not cyclic";
			break;
		case NDG_CONG:
			sd = "|" + ANAME(d.p[0]) + ANAME(d.p[1]) + "| != |" + ANAME(d.p[2])
					+ ANAME(d.p[3]) + "|";
			break;
		case NDG_TRIPLEPI: {
			final int n = d.getRedundantPt();
			if (n == 0)
				sd = Cm.sangle + "[" + ANAME(d.p[0]) + ANAME(d.p[1]) + ", "
						+ ANAME(d.p[2]) + ANAME(d.p[3])
						+ "] != (n*PI) / 3 (n = 0, 1, 2, 3 ..)";
			else {
				int a, b;
			...
			if (dx1 != null) {
				...
				if (n == n1) {
					if ((v1.pt[2] == v2.pt[0]) && (v1.pt[3] == v2.pt[1])) {
						...
						p1 = pminus(p1,
								trim_f(v1.pt[0], v1.pt[1], v2.pt[2], v2.pt[3]));
						if (n != 1) {
							p1 = ptimes(get_n(n), p1);
							return pminus(x, p1);
						}
						...
						xterm p1 = pplus(get_m(v1), get_m(v2));
						p1 = pminus(p1,
								trim_f(v2.pt[0], v2.pt[1], v1.pt[2], v1.pt[3]));
						if (n != 1) {
							p1 = ptimes(get_n(n), p1);
							return pminus(x, p1);
						}
					...
					if ((v1.pt[0] == v2.pt[0]) && (v1.pt[1] == v2.pt[1])) {
						...
						xterm p1 = pminus(get_m(v1), get_m(v2));
						p1 = pminus(p1,
								trim_f(v1.pt[0], v1.pt[1], v2.pt[0], v2.pt[1]));
						if (n != 1) {
							p1 = ptimes(get_n(n), p1);
							return pminus(x, p1);
						}
	...
	// //////////////////////////////////////////////////////////////////////////////
	// ndg deduction.
	public void ndg_deduction(ArrayList<cndg> v3, ArrayList<cndg> v4) {

		for (int i = 0; i < v3.size(); i++) {
			final cndg d = v3.get(i);
			if (d.exists) {
	...
	public static int compare(cndg d1, cndg d2) {
		if (d1 == d2)
			return 0;

		final int n1 = d1.getMaxInt();
		final int n2 = d2.getMaxInt();
		if (n1 > n2)
			return 1;
		if (n1 < n2)
			return -1;
	...
	public void parse_neq(ArrayList<cndg> v4) {

		sortVector(v4);
		final ArrayList<cndg> v5 = new ArrayList<cndg>();

		for (int i = 0; i < v4.size(); i++) {
			final cndg d1 = v4.get(i);
			if ((d1.type != NDG_NEQ) && (d1.type != NDG_NON_ISOTROPIC))
				continue;
			if (freeCSP(d1.p[0]) && freeCSP(d1.p[1]))
				continue;
		...
		for (int i = 0; i < v5.size(); i++) {
			final cndg d = v5.get(i);
			final ndgcs c = parse_neq(d);
			updateSD(c);
	...
	private void updateSD(ndgcs dd) {
		...
		for (int i = 0; i <= dd.no; i++) {
			final cons c1 = dd.allcns[i];
			if (c1 != null) {
				updatePSS(c1);
				c1.setText(null);
			}
		}
		for (final ndgcs element : dd.child)
			if (element != null)
				updateSD(element);
	}

	public ndgcs getCS(cndg d) {// d : type of neq.
		final int n = d.getMaxInt();

		final ndgcs c = new ndgcs();
		for (int i = 1; i <= cns_no; i++) {
			final cons c1 = allcns[i];
			if (c1 == null)
				continue;
		...
		final ndgcs dd = new ndgcs();
		for (int i = 0; i <= cns_no; i++) {
			final cons c2 = c.allcns[i];
			if (c2 != null)
	...
	private void updatePSS(cons c) {
		...
		for (int i = 0; i <= c.no; i++)
			c.pss[i] = allpts[c.ps[i]];
	}

	private void add_RelatedCnsToDg(int nx, ndgcs d) {

		final cons c = allcns[nx];
		if (c == null)
			return;

		for (int i = 0; i <= c.no; i++)
			for (int j = 0; j < nx; j++) {
				final cons c1 = allcns[j];
				if (c1 == null)
					continue;
				if (!construct_related(c1.type))
					continue;
	...
	public static void addConsToNdgcs(cons c, ndgcs d) {
		if (c == null)
			return;
		...
		case C_I_LA:
			add_cons(C_O_L, c.ps[0], c.ps[1], c.ps[2], 0, d);
			add_cons(C_O_A, c.ps[0], c.ps[3], c.ps[4], c.ps[5], c.ps[6],
					c.ps[7], c.ps[8], d);
			break;
		case C_I_PT:
			add_cons(C_O_P, c.ps[0], c.ps[1], c.ps[2], c.ps[3], d);
	...
	public static void add_cons(int type, int a, int b, int c, int d, int e, int f,
			int g, ndgcs d1) {
		final cons c1 = new cons(type);
		c1.add_pt(a);
		c1.add_pt(b);
		c1.add_pt(c);
		c1.add_pt(d);
	...
	public static void add_cons(int type, int a, int b, int c, int d, ndgcs d1) {
		final cons c1 = new cons(type);
		c1.add_pt(a);
		c1.add_pt(b);
		c1.add_pt(c);
	...
	public boolean ck_right(cons c, ndgcs cs, int type) {
		...
		case C_O_L:
			return !ck_recursive_ndg(type, cs, NDG_COLL, c.ps[0], c.ps[1],
					c.ps[2], 0);
		case C_O_T:
			return !ck_recursive_ndg(type, cs, NDG_PARA, c.ps[0], c.ps[1],
					c.ps[2], c.ps[3]);
		case C_O_P:
			return !ck_recursive_ndg(type, cs, NDG_PERP, c.ps[0], c.ps[1],
					c.ps[2], c.ps[3]);
		}
		return true;
	}
	...
	private void rm_excons(ndgcs c) {
		...
		final ndgcs[] css = c.child;
		final int a = c.getCSindex();
		if (a < 0)
			for (int i = 0; i <= c.no; i++) {
				if (c.allcns[i] == null)
					continue;
	...
	private static boolean cons_ex(ndgcs cs, int index) {
		final cons c = cs.allcns[index];
	...
	public boolean ck_right(ndgcs c, int type) {
		...
		if (a < 0)
			...
			for (int i = 0; i <= a; i++) {
				if (css[i] != null)
					return true; // XXX Changed the logic here. Not sure what it is supposed to do.
			}
			//		return false;
		}
		return true;
	...
	public ndgcs parse_neq(cndg nd) {
		final ndgcs c = getCS(nd);
		final ndgcs cx = new ndgcs(c);
		cx.parent = c;
		c.addChild(cx);
	...
	private static int compare(cons c1, cons c2) {
		if (c1 == null) {
			if (c2 == null)
				return 0;
			return -1;
		...
		if (c2 == null)
			return 1;
		final int n1 = c1.getLastPt();
		final int n2 = c2.getLastPt();
		...
		if (c.leaf) {
			for (int i = 0; i <= c.no; i++)
				for (int j = i + 1; j <= c.no; j++)
					...
					} else if (c.allcns[j] != null)
						if (compare(c.allcns[i], c.allcns[j]) > 0) {
							final cons cx = c.allcns[i];
							c.allcns[i] = c.allcns[j];
							c.allcns[j] = cx;
						}
		} else {
			final int n = c.getCSindex();
			for (int i = 0; i <= n; i++)
	...
	private boolean parseStep(ndgcs c) { // Main Process of Parsing.
		...
		final int max = c.getMaxCnsInt();

		final int n = c.no;
		for (int i = 0; i <= n; i++) {
			final cons c1 = c.allcns[i];
			if (c1 == null)
				continue;
			if (c1.getLastPt() != max)
				continue;
						...
						for (int m = 0; m <= c.no; m++) {
							...
							case C_O_L:
								if (xcoll(pp[i], pp[j], pp[k])) {
									...
									if (!ck_recursive_ndg(1, c, NDG_NEQ, pp[i],
											pp[j], 0, 0)) {
										final ndgcs nc1 = new ndgcs(c); // !
																		// Collinear
																		// A, B,
																		// C
										nc1.parent = c;
										c.addChild(nc1);
										final cons cc = new cons(C_I_EQ);
										cc.add_pt(pp[i]);
										cc.add_pt(pp[j]);
										cc.reorder();
	...
	private static void addPtNoRedunent(int p, int[] pp) {
		for (int i = 0; i < pp.length; i++) {
			if (pp[i] == p)
				return;
			if (pp[i] == 0) {
	...
	private boolean parse_ndg_ll(ndgcs c, cons c1, cons c2) {
		...
		{
			final ndgcs nc1 = new ndgcs(c); // ! Collinear A, B, C
			nc1.parent = c;
			c.addChild(nc1);
			final cons cc = new cons(C_I_EQ);
			cc.add_pt(n1);
			...
			cc.reorder();
			ndg_pteq_added(cc, nc1);
			nc1.nd = add_ndg_coll(m, a, b);
			parseStep(nc1);
		}

		if (!ck_recursive_ndg(1, c, NDG_COLL, m, a, b, 0)) {
			final ndgcs nc2 = new ndgcs(c); // Collinear M A B; A != B
			nc2.parent = c;
			c.addChild(nc2);
			final cons cc = new cons(C_O_L);
			cc.add_pt(m);
			cc.add_pt(a);
			cc.add_pt(b);
			ndg_coll_added(cc, nc2);
			nc2.nd = add_ndg_neq(a, b);
			parseStep(nc2);
		}

		if (!ck_recursive_ndg(1, c, NDG_NEQ, a, b, 0, 0)) {
			final ndgcs nc3 = new ndgcs(c); // A = B.
			nc3.parent = c;
			c.addChild(nc3);
			final cons cc = new cons(C_I_EQ);
			cc.add_pt(a);
	...
	private boolean ck_recursive_ndg(int type, ndgcs cs, int t, int a, int b,
			int c, int d) {

		if (type == 0) {
			for (int i = 0; i < vndgs.size(); i++) {
				final cndg dx = vndgs.get(i);
	...
	private static boolean ck_ndg(int t, int a, int b, int c, int d, cndg dd) {
		boolean r = false;
	...
	private boolean parse_ndg_lt(ndgcs c, cons c1, cons c2) {
		...
		{
			final ndgcs nc2 = new ndgcs(c); // OtherWise.
			nc2.parent = c;
			c.addChild(nc2);
			final cons cc2 = new cons(C_I_EQ);
			cc2.add_pt(n1);
			cc2.add_pt(m);
			nc2.add(cc2);
			ndg_pteq_added(cc2, nc2);
			nc2.nd = add_ndg_neq(m, b);
			parseStep(nc2);
		}
	...
	private static void ndg_pteq_added(cons c, ndgcs d) {
		final int m = c.ps[0];
		final int a = c.ps[1];
		for (int i = 0; i <= d.no; i++) {
			final cons c2 = d.allcns[i];
			if ((c2 == null) || (c2 == c))
				continue;
			c2.replace(m, a);
		}
	...
	private static void ndg_coll_added(cons c, ndgcs d) {
		final int m = c.ps[0];
		final int a = c.ps[1];
		final int b = c.ps[2];
	...
	private static void opt_cons(ndgcs c) {
	...
	private static boolean opt_cons(ndgcs cs, cons c) {
		if (c == null)
			return false;
	...
	private static boolean add_eq(int a, int b, ndgcs c) {
		if (a == b)
			return false;
		if ((a == 0) || (b == 0))
			return false;
	...
	private static void rm_redundent(ndgcs c) {
		for (int i = 0; i <= c.no; i++) {
			final cons c1 = c.allcns[i];
	...
	private static boolean cons_redundent(cons c) {
		switch (c.type) {
		case C_O_L:
			return (c.ps[0] == c.ps[1]) || (c.ps[0] == c.ps[2])
					|| (c.ps[1] == c.ps[2]);
		case C_O_T:
		case C_O_P:
		...
		case C_CIRCUM:
			return (c.ps[0] == c.ps[1]) && (c.ps[1] == c.ps[2])
					&& (c.ps[2] == c.ps[3]);
		}
		return false;
	}

	public static boolean construct_related(int t) {
		if ((t == C_POINT) || (t == C_TRIANGLE) || (t == C_POLYGON)
				|| (t == C_QUADRANGLE) || (t == C_PENTAGON) || (t == C_LINE)
				|| (t == C_CIRCLE))
			return false;
		if ((t >= 50) && (t <= 100))
			return false;
	...
	private boolean addNdg(cons c) {
		switch (c.type) {
		case C_O_L:
			add_n_coll(c.ps[0], c.ps[1], c.ps[2], vndgs);
			break;
		case C_O_P: {
			final cndg d = add_ndg_para(c.ps[0], c.ps[1], c.ps[2], c.ps[3]);
			add_ndgs(d, vndgs);
		}
			break;
		case C_O_T: {
			final cndg d = add_ndg_perp(c.ps[0], c.ps[1], c.ps[2], c.ps[3]);
			add_ndgs(d, vndgs);
		}
			break;
		case C_I_EQ: {
			final cndg d = add_ndg_neq(c.ps[0], c.ps[1]);
			add_ndgs(d, vndgs);
		}
			break;
		default:
	...
	private final ArrayList<cndg> vndgs = new ArrayList<cndg>();
