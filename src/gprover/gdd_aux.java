...
/* main entry */
    ...
    private static boolean isaux_contpt(auxpt ax, Pro_point pt) {
        int n = ax.getPtsNo();
        for (int i = 0; i < n; i++) {
            Pro_point p = ax.getPtsbyNo(i);
            if (isSamePt(pt, p))
                return true;
        }
        return false;
    ...
    private static boolean isSamePt(Pro_point p1, Pro_point p2) {
    ...
    static Pro_point aux_pt(int aux, int type) {
...
//                        if (aux_mid(2, p1, p2) != 0) return;
    ...
    void ax_tn_as(t_line tn) {
        ...
        while (as1 != null) {
            ...
            if (m == 0 && p2 != 0 && p3 != 0) {
                auxpt_ill(3, p2, p3, p1, get_lpt1(ln1, p1));
            } else if (m != 0 && p2 != 0 && p3 == 0) {
                auxpt_ill(1, m, p2, p1, get_lpt1(n2, p1));
            } else if (m != 0 && p2 == 0 && p3 != 0) {
                auxpt_ill(1, m, p3, p1, get_lpt1(n1, p1));
            } else {
                as1 = as1.nx;
                continue;
            }
...
////////////////////////////////////////////////////////////////
    ...
    static double[] cal_inter_lc(double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4) {
