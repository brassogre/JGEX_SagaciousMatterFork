...
public class gdd_bc extends gdd_aux {
    ...
    void prove_fix() {
        ...
        if (conc.pred == CO_NANG) {
            ...
            ArrayList<auxpt> v = new ArrayList<auxpt>();
            v.addAll(vauxpts);
            int n = v.size();
            if (n > 0) {
    ...
    static int finter_ll(l_line l1, l_line l2) {
        char i, j;
...
//            break;
                ...
                if (as1 != null && as2 != null) {
                    ...
                    for (int i = 0; i < 4; i++) {
                        if (on_ln(pr.p[2 * i], pr.p[2 * i + 1], ls)) {
                            gddbase.add_pt2l(pr.p[2 * i], ln);
                            gddbase.add_pt2l(pr.p[2 * i + 1], ln);
                        }
                    }
    ...
    static boolean compare_pred(cond co, cond pr)   // do_pred(x,x,3)   ----------> check two predicate is the same.
    {
    ...
    static boolean check_pred(cond co) // if it obviousely.
    {
        boolean va = false;
        switch (co.pred) {
            case 0:
    ...
    static boolean eq_chs(int[] ch1, int n1, int[] ch2, int n2)   // Check !!
    {
        int id1 = 1;
    ...
    public ArrayList<cclass> getAll_md() {
    ...
    public ArrayList<cclass> getAll_ln() {
        ArrayList<cclass> v = new ArrayList<cclass>();
        l_line ln = all_ln.nx;
        while (ln != null) {
    ...
    public ArrayList<cclass> getAll_pn() {
        ArrayList<cclass> v = new ArrayList<cclass>();
        p_line pn = all_pn.nx;
        while (pn != null) {
            if (pn.type != 0)
    ...
    public ArrayList<cclass> getAll_tn() {
        ArrayList<cclass> v = new ArrayList<cclass>();
        t_line tn = all_tn.nx;
        while (tn != null) {
            if (tn.type != 0)
    ...
    public ArrayList<cclass> getAll_cir() {
        ArrayList<cclass> v = new ArrayList<cclass>();
        a_cir cr = all_cir.nx;
        while (cr != null) {
    ...
    public ArrayList<cclass> getAll_as() {
        ArrayList<cclass> v = new ArrayList<cclass>();
        angst ast = all_ast.nx;
        while (ast != null) {
            if (ast.type != 0)
    ...
    public ArrayList<cclass> getAll_at() {
        ArrayList<cclass> v = new ArrayList<cclass>();
        anglet at = all_at.nx;
        while (at != null) {
            if (at.type != 0)
    ...
    public ArrayList<cclass> getAll_atn() {
        ArrayList<cclass> v = new ArrayList<cclass>();
        angtn at = all_atn.nx;
        while (at != null) {
            if (at.type != 0)
    ...
    public ArrayList<cclass> getAll_cg() {
        ArrayList<cclass> v = new ArrayList<cclass>();
    ...
    public ArrayList<cclass> getAll_rg() {
        ArrayList<cclass> v = new ArrayList<cclass>();
        cong_seg cg = all_rg.nx;
        while (cg != null) {
            if (cg.type != 0)
    ...
    public ArrayList<cclass> getAll_st() {
        ArrayList<cclass> v = new ArrayList<cclass>();
    ...
    public ArrayList<cclass> getAll_ct() {
        ArrayList<cclass> v = new ArrayList<cclass>();
    ...
    public ArrayList<cclass> getAll_ra() {
        ArrayList<cclass> v = new ArrayList<cclass>();
        ratio_seg ra = all_ra.nx;
        while (ra != null) {
            if (ra.type != 0)
    ...
    public ArrayList<cclass> getAll_sts() {
        ArrayList<cclass> v = new ArrayList<cclass>();
        s_tris sts = all_sts.nx;
        while (sts != null) {
            if (sts.type != 0)
    ...
    public ArrayList<cclass> getAll_cts() {
        ArrayList<cclass> v = new ArrayList<cclass>();
    ...
    public ArrayList<cclass> search_a_fact(int t, String s1, String s2, String s3) {
    ...
    private void fo_atn2(int a, int b, int c, Collection<cclass> v) {
        angtn atn = all_atn.nx;
    ...
    s_tris fo_tri2(int a, int b, int c, Collection<cclass>  v) {
    ...
    cclass fo_cg2(int a, int b, Collection<cclass> v) {
        c_segs cgs = all_cgs.nx;
...
///// for backward chaining.
    ...
    public void parse_llist() {
        ...
        ArrayList<l_list> v = getPVector();
        last_ns = ns;
        ns.nx = null;
        show_llists(v);

        ArrayList<l_list> vl = new ArrayList<l_list>();
...
/*    public static void search_p_list(ArrayList<l_list> v) {
        for (l_list ls : v) {
    ...
    public static boolean equal_md(mnde m1, mnde m2) {
    ...
    public ArrayList<l_list> getPVector() {
        ArrayList<l_list> v = new ArrayList<l_list>();
        l_list ns = all_ns.nx;
        while (ns != null) {
            int n = ns.get_npt();
            int i = 0;
...
//    }
    ...
    public void show_llists(ArrayList<l_list> v) {
    ...
    public static angtr find_tr_in_ls(angtr t, l_list ls) {
        for (int i = 0; i < ls.nd; i++) {
            angtr t1 = ls.md[i].tr;
