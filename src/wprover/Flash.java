...
public abstract class Flash {
    ...
    protected int TIME_INTERVAL = UtilityMiscellaneous.getFlashInterval();


    public void updateTimer() {
        if (timer != null)
            timer.setDelay(UtilityMiscellaneous.getFlashInterval());
    }
    ...
    final public static void setDrawDash(Graphics2D g2) {
    ...
    final public static boolean isZero(double d) {
    ...
    final public static void drawAngle(double x1, double y1, double x2, double y2,
        ...
        if (UtilityMiscellaneous.ANGLE_TYPE == 1) {
    ...
    public static void drawAngle(GEPoint p1, GEPoint p2, GEPoint p3, GEPoint p4,
                                 int rad, Graphics2D g2) {
    ...
    static boolean spt(double x0, double y0, double x, double y) {
        return Math.pow(x0 - x, 2) + Math.pow(y0 - y, 2) <
                UtilityMiscellaneous.ZERO * UtilityMiscellaneous.ZERO;
    }

    static public void drawALine3Short(GEPoint p1, GEPoint p2, double x, double y,
                                       Graphics2D g2) {
    ...
    static public void drawALine3(GEPoint p1, GEPoint p2, double x, double y,
