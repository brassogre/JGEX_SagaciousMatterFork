 ...
 */
public class PopupMenuRightTransform extends JPopupMenu implements ItemListener, ActionListener {

    /**
	 * 
	 */
	private static final long serialVersionUID = 3115637121443872270L;
	private DrawPanel dp;
    private JRadioButtonMenuItem m1, m2, m3;
    private JMenuItem m;
    private int xx, yy;

    public PopupMenuRightTransform(DrawPanel d) {
        dp = d;
