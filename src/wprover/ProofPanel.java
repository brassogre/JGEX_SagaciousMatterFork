...
public class ProofPanel extends JTabbedPane implements ChangeListener {
...
//        }
    ...
    public void stateChanged(ChangeEvent e) {
        ...
        if (gxInstance != null) {
        	gxInstance.showProveBar(comp == mpPanel);
        }
    }

    public void openFromXMLDocument(Element rootElement) {
    	assert(rootElement != null);
    	if (rootElement != null) {
    		
    		mnode mainMnode = null;
    		boolean bFoundMultiples = false;
			gterm gt = new gterm();
    		...
    		for (int j = 0; j < nl.getLength(); ++j) {
        		...
        		if (child != null && child instanceof Element) {
        			String sTag = ((Element)child).getTagName();
        			if (sTag != null && sTag.equalsIgnoreCase("argument")) {
        	    		if (gt.openFromXMLDocument((Element)child)) {
        			...
        			if (sTag != null && sTag.startsWith("Node:")) {
        				bFoundMultiples = (mainMnode != null);
        				mainMnode = mnode.createFromXMLDocument((Element)child);
        			}
        		}
    		}
    		if (mainMnode != null && !bFoundMultiples)
    			loadMTree(mainMnode);
	...
	public void saveIntoXMLDocument(Element rootElement) {
    	assert(rootElement != null);
    	if (rootElement != null) {
    		condPane.saveIntoXMLDocument(rootElement);
    		mnode node = getmproveNode();
    		if (node != null)
    			node.saveIntoXMLDocument(rootElement);
    	}
    }
...
//                        RuleListDialog dlg = new RuleListDialog(gxInstance);
                        ...
                        if (dlg.loadRule(false, c.getRule()))
                            dlg.setVisible(true);
                    } else if (t == 1) {
    ...
    private void createFullTreePanel() {
        ...
        DefaultTreeModel modell = new DefaultTreeModel(top_full);
        tree_full = new JTree(modell);
...
//                        RuleListDialog dlg = new RuleListDialog(gxInstance);
		...
		dp.getPointList(vp);
                ...
                if (cc instanceof gr_term) {
                    ...
                    ArrayList<xterm> list = gr.getAllxterm();
                    ...
                    ArrayList<cond> vl = e1.getAllCond();
                    ...
                    ArrayList<xterm> list = e1.getAllxterm();
                    for (int i = 0; i < list.size(); i++) {
                        xterm x = list.get(i);
                        dp.addFlashXtermAngle(x);
                    }
...
//        this.addTab("M", mpPanel);
    ...
    public boolean selectAPoint(GEPoint p) {
    ...
    public void addConclusion(String s) {
        ...
        condPane.getAllPointNames(v);
        cdialog.setPointNames(v);
    ...
    public void displayDatabase(long t) {
        ...
        ArrayList<cclass> v1 = db.getAll_ln();
        size = v1.size();
        if (size != 0) {
...
//        }
        ...
        v1 = db.getAll_rg();
        ArrayList<cclass> v2 = db.getAll_ra();
        v1.addAll(v2);
        size = v1.size();
        if (size != 0) {
    ...
    public void show_AllFullAux(boolean ang) {
        ...
        while (!v.isEmpty()) {
            DefaultMutableTreeNode n = v.remove(0);
            ...
            if (obj instanceof gr_term) {
                ...
                ArrayList<var> v1 = g.getAllvars();
                for (int i = 0; i < v1.size(); i++) {
                    var vr = v1.get(i);
                    GELine ln1 = dp.addLn(vr.pt[0], vr.pt[1]);
                    GELine ln2 = dp.addLn(vr.pt[2], vr.pt[3]);
                    GEPoint p1 = dp.fd_point(vr.pt[0]);
                    GEPoint p2 = dp.fd_point(vr.pt[1]);
                    GEPoint p3 = dp.fd_point(vr.pt[2]);
                    GEPoint p4 = dp.fd_point(vr.pt[3]);
                    if (ang && dp.fd_angle_4p(p1, p2, p3, p4) == null) {
                        GEAngle ag = new GEAngle(ln1, ln2, p1, p2, p3, p4);
                        ag.setAngleText("");
                ...
                ArrayList<xterm> v1 = el.getAllxterm();
                for (int i = 0; i < v1.size(); i++) {
                    xterm x = v1.get(i);
                    var vr = x.var;
                    if (vr == null) {
        ...
        removeFromListLast_n_Elements(dp.anglelist, t);
        ...
        removeFromListLast_n_Elements(dp.linelist, t);
        if (k >= s2) {
            k = k - s2;
            t = s2;
        } else {
        ...
        removeFromListLast_n_Elements(dp.circlelist, t);
    ...
    final public static void removeFromListLast_n_Elements(ArrayList<? extends Object> v, int n) {
        ListIterator<?> iter = v.listIterator(v.size());
        while (n-- > 0 && iter.hasPrevious())
        	iter.remove();
    }
...
//                    f.createNewFile();
//                }
//                FileOutputStream fp = new FileOutputStream(f, bExists);
//                gterm t = condPane.getTerm();
//                t.writeAterm(fp);
//                fp.close();
...
//    }
    ...
    private static void expandOrCollpaseTree(JTree tree) {
        if (tree == null) {
            return;
        }
        boolean exp = false;
    ...
    private void createNodes(ArrayList<cond> vl) {
    ...
    public void add_predicates(String sh, ArrayList<cclass> v) {
    ...
    public void addProveTree(ArrayList<cond> vl, ArrayList<cons> vd) {
        clearAll();
        if (vl.size() == 0) {
            return;
        }
        cond co = vl.get(vl.size() - 1);
    ...
    public void setListData(ArrayList<cons> v) {
    ...
    class PTNode extends DefaultMutableTreeNode {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 7125160529411031726L;
		public cond co = null;
    ...
    public void finishedDrawing() {
        ...
        ProofPanel.this.setSelectedIndex(0);
    }
    ...
    class popFull extends JPopupMenu implements ActionListener {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -4156927561832937830L;
    ...
    class popMenu extends JPopupMenu implements ActionListener {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2813228350932158623L;
		private Object obj;
            ...
            if (obj instanceof itemLabel) {
                ...
                if (value instanceof cond) {
                    if (command.equals("Prove")) {
                        ProofPanel.this.proveCond((cond) value, false);
                ...
                if (path != null) {
                    ...
                    if (obj2 instanceof DefaultMutableTreeNode) {
                        ...
                        if (obj3 instanceof cclass) {
                            ...
                            if (c != null)
                                ProofPanel.this.proveCond(c, true);
                        }
                    }
                }
            }
...
//            ArrayList<gterm> v = new ArrayList<gterm>();
//            while (true) {
//                gt = new gterm();
...
//    }
    ...
    class ButtonToolBar extends JToolBar implements ActionListener {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -4371933662698989992L;

		private JToggleButton b1, button3, button4, button5, button6, button7;
        ...
        public ButtonToolBar() {
            ...
            b1 = new JToggleButton(new AbstractAction("",
                ...
                /**
						 * 
						 */
						private static final long serialVersionUID = 8538935283817299447L;
...
//                    }
            ...
            button3 = new JToggleButton(new AbstractAction("",
                ...
                /**
						 * 
						 */
						private static final long serialVersionUID = -116623759131724533L;
            ...
            button4 = new JToggleButton(new AbstractAction("",
                ...
                /**
						 * 
						 */
						private static final long serialVersionUID = 1449710513831910712L;
            ...
            button5 = new JToggleButton(new AbstractAction("",
                ...
                /**
						 * 
						 */
						private static final long serialVersionUID = 3572325676347563690L;
            ...
            button6 = new JToggleButton(new AbstractAction("",
                ...
                /**
						 * 
						 */
						private static final long serialVersionUID = 573039528853873479L;
            ...
            button7 = new JToggleButton(new AbstractAction("",
                ...
                /**
						 * 
						 */
						private static final long serialVersionUID = 4443756577390028447L;
            ...
            label = new JLabel("GDD", DrawPanelFrame.createImageIcon("images/ptree/downsel.gif"), JLabel.HORIZONTAL) {
				 ...
				 * 
				 */
				private static final long serialVersionUID = -3246617415836757912L;
...
//        Vector v = g.pc();
        ArrayList<cons> v1 = new ArrayList<cons>();
        ArrayList<cndg> v2 = new ArrayList<cndg>();
        ArrayList<cndg> v3 = new ArrayList<cndg>();
        ArrayList<cndg> v4 = new ArrayList<cndg>();
    ...
    class Conspanel extends JSplitPane implements MouseMotionListener, ListSelectionListener, MouseListener, ActionListener {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 8739035342839980267L;
		private JList<cons> list;
		private JList<String> listx;
        private gterm gt;
        private String lstpt;
        private DefaultListModel<cons> listModel;
        ...
        public Conspanel() {
            ...
            listModel = new DefaultListModel<cons>();
            ...
            tiptext = new JTextPane() {
				 ...
				 * 
				 */
				private static final long serialVersionUID = -3516324169548396091L;
    	...
    	public void saveIntoXMLDocument(Element rootElement) {
        	...
        	if (rootElement != null) {
        		if (gt != null)
        			gt.saveIntoXMLDocument(rootElement);
        	}
    	}
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (command.equals("Detail Construction")) {
                ...
                ProofPanel.this.addConclusion("Add Conclusion");
            } else if (command.equals("NDGS")) {
                ProofPanel.this.addConclusion("Add Nondegenerate Conditions");
                cdialog.setType(1);
        ...
        public void setListSelection(cons c) {
            ...
            lstpt = null;
            if (!c.is_conc()) {
                GEPoint p = dp.getLastConstructedPoint();
                if (p != null)
                    lstpt = p.getname();
            }
        ...
        public void setConstruction(ArrayList<cons> v) {
        }

        public void setVector(ArrayList<cons> v) {
            if (gt == null)
                gt = new gterm();
...
//                dp.flashCond(gt.getConc(), true);
        ...
        public void setConstruction(gterm gt) {
            ...
            gt.fillListModels(listModel, listModelx);
        }
        ...
        class clistRender extends JPanel implements ListCellRenderer<cons> {
            /**
			 * 
			 */
			private static final long serialVersionUID = 6935834016631607767L;
			private boolean selected = false;
            private ArrayList<DefaultListCellRenderer> vlist = new ArrayList<DefaultListCellRenderer>();
            ...
            public Component getListCellRendererComponent(JList<? extends cons> list,
                                                          cons value,
                                                          int index,
                                                          boolean isSelected,
