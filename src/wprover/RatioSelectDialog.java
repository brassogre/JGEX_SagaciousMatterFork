...
public class RatioSelectDialog extends JBaseDialog implements ActionListener {
    ...
    public RatioSelectDialog(GExpert f) {
        ...
        this.setTitle(GExpert.getLanguage(2201, "Set the ratio"));

        Container contentPane = getContentPane();
        contentPane.setLayout(new BoxLayout(contentPane, BoxLayout.Y_AXIS));

        JLabel labelx = new JLabel(GExpert.getLanguage(2200, "Please input two integers"));
        ...
        button1 = new JButton(GExpert.getLanguage(3204, "OK"));
        button2 = new JButton(GExpert.getLanguage("Cancel"));
        p1.add(button1);
        p1.add(button2);
