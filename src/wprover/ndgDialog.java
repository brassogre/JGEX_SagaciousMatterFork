...
public class ndgDialog extends JBaseDialog implements ActionListener, MouseMotionListener, MouseListener,
    ...
    public ndgDialog(GExpert gx, gterm gt, drawProcess dp) {
        super(gx.getFrame(), GExpert.getLanguage(1116, "Nondegenerate Conditions"));
        gxInstance = gx;
        ...
        String c1 = GExpert.getLanguage(1138, "The Simplified Nondegenerate Conditions");
        String c2 = GExpert.getLanguage(1139, "The Final Nondegenerate Conditions");
...
//        tabel1.setBorder(BorderFactory.createTitledBorder(""));
    ...
    class ndgTableModel extends DefaultTableModel {
		...
		String c1 = GExpert.getLanguage(1137, "Construction");
        String c2 = GExpert.getLanguage(1116, "Nondegenerate Condition");
