 ...
 */             
public class DialogAttrToCond extends DialogBase {
    /**
	 * 
	 */
    ...
    public DialogAttrToCond(DrawPanelFrame gx, String s) {
...
//            gx.addDependentDialog(this);
    ...
    public DialogAttrToCond(DrawPanelFrame gx, l_line ln) {
    ...
    public DialogAttrToCond(DrawPanelFrame gx, a_cir cr) {
    ...
    public DialogAttrToCond(DrawPanelFrame gx, angst st) {
    ...
    public DialogAttrToCond(DrawPanelFrame gx, s_tris st) {
    ...
    public DialogAttrToCond(DrawPanelFrame gx, c_segs cg) {
    ...
    public DialogAttrToCond(DrawPanelFrame gx, p_line pn) {
    ...
    class ButtonPane extends JPanel implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (o == bcancel)
                co = null;
            DialogAttrToCond.this.setVisible(false);
        }
    }
