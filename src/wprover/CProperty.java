...
public class CProperty extends JPanel implements ActionListener {
	...
	class Panel_CS extends JPanel implements ActionListener {
		...
		public Panel_CS() {
			...
			final ColorComboRender render1 = new ColorComboRender(2, 100, 20);
			...
			final ColorComboRender render2 = new ColorComboRender(1, 100, 20);
		...
		public void setVariable(GraphicEntity dp) {
			...
			((CCoBox) color).setSelectedIndex(dp.m_color);
...
//		}
	...
	class Panel_Angle extends JPanel implements ActionListener,
		...
		public Panel_Angle() {
			...
			final ColorComboRender cr = new ColorComboRender(0, 100, 20);
	...
	class Panel_Polygon extends JPanel implements TableModelListener {
		...
		public Panel_Polygon() {
			...
			final JTable tb1 = CProperty.createTable(getLanguage(730, "Type"),
					"");
			final TableColumn cn1 = tb1.getColumnModel().getColumn(1);
			comboBox = new JComboBox<String>();
			for (int i = 0; i < type.length; i++) {
