...
//                this.setObjectListForFlash(this.fd_line());
    ...
    public ArrayList<JFlash> getAcongFlash(JPanel panel, cond co) {
        ArrayList<JFlash> v = new ArrayList<JFlash>();
        if (co.pred == gib.CO_ACONG) {
            int[] vp = co.p;
            if (vp[0] == 0) {
                return null;
    ...
    public JFlash getMAngleFlash(JPanel panel, GEPoint p1, GEPoint p2, GEPoint p3, GEPoint p4, int t) {
 ...
 /*   public static void flashMpnode(mobject obj) {
    ...
    public JFlash getDrobjFlash(mdrobj d) {
        ...
        if (t1 == mdrobj.LINE) {
            ...
            if (d.getObjectNum() == 3) {
                JFlash f = this.getMAngleFlash(panel, d.getObject(0), d.getObject(1),
    ...
    public void flashassert(massertion ass) {
        ...
        switch (ass.getAssertionType()) {
            ...
            case massertion.ANGLESS: {
                if (ass.getobjNum() == 6) {
                    JFlash f = this.getMAngleFlash(panel, (GEPoint) ass.getObject(0), (GEPoint) ass.getObject(1),
...
//                CPoint p4 = (CPoint) ass.getObject(3);
    ...
    public JAngleFlash find_angFlash(GEPoint a, GEPoint b, GEPoint c, GEPoint d) {
        for (int i = 0; i < flashlist.size(); i++) {
            JFlash flash = flashlist.get(i);
