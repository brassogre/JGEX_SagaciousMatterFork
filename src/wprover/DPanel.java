...
public class DPanel extends JPanel implements MouseListener, MouseMotionListener, MouseWheelListener, ComponentListener {
...
//        this.setBorder(new GBevelBorder(GBevelBorder.RAISED));
        setBackground(CMisc.getBackGroundColor());
    }
