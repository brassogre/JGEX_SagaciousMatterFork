 ...
 */
public class DialogSpecificAngle extends DialogBase implements ActionListener, ItemListener {
    /**
	 * 
	 */
	private static final long serialVersionUID = -298666792827012212L;
    ...
    public DialogSpecificAngle(DrawPanelFrame owner, int type, ArrayList<Integer> v) {
        super(owner.getFrame(), true);
        gxInstance = owner;

        JPanel panel = new JPanel(new GridLayout(1, 6));
        this.setTitle(DrawPanelFrame.getLanguage(104, "Angle Specification"));
        ...
        bok = new JButton(DrawPanelFrame.getLanguage("OK"));
        bca = new JButton(DrawPanelFrame.getLanguage("Cancel"));
    ...
    public ArrayList<Integer> getSpecifcAngle() {
