 ...
 */
public class DialogUndoEdit extends DialogBase implements WindowListener {
    /**
	 * 
	 */
    ...
    public DialogUndoEdit(DrawPanelFrame owner) {
        super(owner.getFrame());
        this.setTitle(DrawPanelFrame.getLanguage(157, "Construct History"));
