 ...
 */
public class PanelColorComboRender extends JPanel
        implements ListCellRenderer<Integer>, TableCellRenderer {
    /**
	 * 
	 */
	private static final long serialVersionUID = -5743983417625004235L;
    ...
    public PanelColorComboRender(int type, int w, int h) {
        setOpaque(true);
        this.type = type;
