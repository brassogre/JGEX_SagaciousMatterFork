 ...
 */
public class UtilityMiscellaneous {
...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    final public static int PIXEPS_PT2 = PIXEPS_PT * PIXEPS_PT;
    ...
    public static void setDiagramChanged() {
    ...
    public static Font getFont(String s) {
        String[] ss = s.split(" ");
        int n1 = Integer.parseInt(ss[ss.length - 2].trim());
        int n2 = Integer.parseInt(ss[ss.length - 1].trim());
	String sFontName = ss[0].trim();
	int i = 0;
	while (++i < ss.length - 2)
	    sFontName += " " + ss[i].trim();
        return new Font(sFontName, n1, n2);
    }
        ...
        while (s1 != null) {
            if (s1.length() > 0) {
                ...
                if (m1.equalsIgnoreCase("ScreenX")) {
                    ...
                    UtilityMiscellaneous.print("Not Found: " + m1);
            }
            s1 = in.readLine();
        }
        in.close();
