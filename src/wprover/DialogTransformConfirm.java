 ...
 */
public class DialogTransformConfirm extends DialogBase implements ActionListener {

    /**
	 * 
	 */
	private static final long serialVersionUID = -5787860692700788015L;
	int result = -1;

    public DialogTransformConfirm(Frame f, String s1, String s2) {
        ...
        AbstractAction aaa = new AbstractAction() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 3224714495909488423L;
			...
			public void actionPerformed(ActionEvent e) {
                ...
                DialogTransformConfirm.this.setVisible(false);
            }
        };
