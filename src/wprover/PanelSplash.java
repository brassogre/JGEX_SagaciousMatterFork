 ...
 */
public class PanelSplash extends JPanel implements MouseListener {

    /**
	 * 
	 */
	private static final long serialVersionUID = -128027993732617717L;
	JLabel b2;
    Color color = new Color(206, 223, 242);
    DrawPanelFrame gx;


    public PanelSplash(DrawPanelFrame f) {
...
//    }
    ...
    public JDialog runx() {
        ...
        PanelSplash w = this; //new welcomeDialog(gx);
