...
public class DialogFactFinder extends DialogBase implements ActionListener, ItemListener {

    /**
	 * 
	 */
	private static final long serialVersionUID = -2323983628568942425L;
    ...
    private JComboBox<String> bs;
    private JComboBox<GEPoint> b1, b2, b3;
    private JButton bsearch, breset, bcancel;
    private int find_type;
    private DefaultListModel<cclass> model;
    private JList<cclass> list;


    public DialogFactFinder(DrawPanelFrame owner, int type, String title) {
        ...
        b1 = new JComboBox<GEPoint>();
        b1.addItemListener(this);
        b2 = new JComboBox<GEPoint>();
        b2.addItemListener(this);
        b3 = new JComboBox<GEPoint>();
        ...
        p3.add(bcancel);
        panel.add(p3);
        model = new DefaultListModel<cclass>();
        list = new JList<cclass>(model);
