...
public class DialogRuleList extends DialogBase {
    ...
    public DialogRuleList(DrawPanelFrame gx) {
        super(gx.getFrame());
        gxInstance = gx;
        init();
    }

    public DialogRuleList(GApplet gx) {
        super(gx.getFrame());
        gxInstance = null;
        init();
    }
    ...
    public void init() {
        if (gxInstance != null && UtilityMiscellaneous.isApplication())
	...
	@Override
        ...
        public void setRule(boolean bFullAngleMethod, Rule r) {
	...
	@Override
        public void mouseClicked(MouseEvent e) {
            ...
            if (!bRuleTypeFullAngle)
                DrawPanelFrame.openURL("file:///" + dr + sp + "help" + sp + "GDD" + sp + "r" + ruleNumber + ".html");
            else
                DrawPanelFrame.openURL("file:///" + dr + sp + "help" + sp + "FULL" + sp + "r" + ruleNumber + ".html");
