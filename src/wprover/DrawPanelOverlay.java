...
public class DrawPanelOverlay extends JPanel implements MouseListener, MouseMotionListener, MouseWheelListener, ComponentListener {
    ...
    public boolean userActionMayProceed() {
        return gxInstance == null || !gxInstance.getProofPanel().isProverRunning();
    }

    public DrawPanelOverlay(DrawPanelFrame gx, DrawPanelExtended ddd) {
        gxInstance = gx;
