 ...
 */
public class DialogBase extends JDialog implements ContainerListener, KeyListener {

    /**
	 * 
	 */
	private static final long serialVersionUID = 2054231105239973370L;

	public DialogBase(Frame frame, String title, boolean modal) {
        super(frame, title, modal);
        addKeyAndContainerListenerRecursively(this);
    }

    public DialogBase(Frame frame, boolean modal) {
        this(frame, "", modal);
    }
    ...
    public DialogBase(Frame f, String title) {
        super(f, title);
        addKeyAndContainerListenerRecursively(this);
    }

    public DialogBase(Frame f) {
        super(f);
        addKeyAndContainerListenerRecursively(this);
    }
