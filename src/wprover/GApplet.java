...
public class GApplet extends JApplet {
	...
	private void addAnimation() {
		if (getAnimationTool()) {
			final Animation c = dp.getAnimateC();
			if (c != null) {
				final ToolBarAnimate bar = new ToolBarAnimate(null, d, dp); // null,
																		// false);
				bar.setAttribute(c);
	...
	public void setAppletGridColor() {
		...
		if (s != null) {
			final int n = Integer.parseInt(s);
			UtilityMiscellaneous.setGridColor(new Color(n));
		}
	}

	protected static JToggleButton makeAButton(final String imageName,
	...
	class BReset extends JToolBar implements ActionListener {
		...
		public BReset() {
			...
			final JButton b = new JButton(
					DrawPanelFrame.createImageIcon("images/other/reset.gif"));
