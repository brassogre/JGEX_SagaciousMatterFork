...
public class FlashTLine extends Flash implements ActionListener {
    JLine ln1, ln2;

    public FlashTLine(JPanel p) {
        super(p);
    ...
    public FlashTLine(JPanel p, GEPoint p1, GEPoint p2, GEPoint p3, GEPoint p4) {
        super(p);
        timer = new Timer(TIME_INTERVAL, this);
        ln1 = new JLine();
        ln2 = new JLine();
    ...
    public boolean draw(Graphics2D g2) {
        ...
        if (n % 2 == 0) {
            ...
            GEPoint[] l1 = ln1.getMaxMinPoint();
            GEPoint[] l2 = ln2.getMaxMinPoint();
            GEPoint p1 = l1[0];
            GEPoint p2 = l1[1];
            GEPoint p3 = l2[0];
            GEPoint p4 = l2[1];
    ...
    static double d2(double x, double y, double x1, double y1) {
        return Math.pow(x - x1, 2) + Math.pow(y - y1, 2);
    }

    static void drawLL3(Graphics2D g2, int x1, int y1, int x2, int y2, int x3, int y3) {
        int x, y, tx, ty;
    ...
    public static void drawTTFoot(Graphics2D g2, double x, double y, GEPoint p1, GEPoint p2) {
    ...
    public boolean containPt(GEPoint p) {
