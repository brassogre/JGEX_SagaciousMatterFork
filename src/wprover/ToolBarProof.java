...
public class ToolBarProof extends FloatableToolBar {
    /**
	 * 
	 */
	private static final long serialVersionUID = 7611248903286706527L;
	ProveBar bar;

    public ToolBarProof(DrawPanelFrame gx) {
...
class ProveBar extends JToolBar implements ActionListener, ChangeListener {
    ...
    public ProveBar(DrawPanelFrame gex) {
        super();
        //gxInstance = gex;
        this.dpane = gex.d;
        this.dp = gex.dp;
    ...
    public void setValue(int n) {
        if (n < 0)
            n = UtilityMiscellaneous.getFlashInterval();
    ...
    public void adjustSpeed() {
        int v = getInterval();
        UtilityMiscellaneous.setFlashInterval(v);
        dp.updateFlashDelay();
        dp.setTimerDelay(v);
    }
