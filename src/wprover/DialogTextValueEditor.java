 ...
 */
public class DialogTextValueEditor extends DialogBase implements ActionListener, KeyListener {

    /**
	 * 
	 */
	private static final long serialVersionUID = 1559040428076434130L;
	TextPaneWuMethod pane1, pane;
    ...
    public DialogTextValueEditor(DrawPanelFrame gx) {
        super(gx.getFrame(), DrawPanelFrame.getLanguage(132, "Calculation"));
        gxInstance = gx;
        ...
        pane1 = new TextPaneWuMethod() {
            /**
			 * 
			 */
			private static final long serialVersionUID = 2199770348598136651L;
...
//        StyleConstants.setForeground(regular, Color.black);
        ...
        ImageIcon im = DrawPanelFrame.createImageIcon("images/ptree/downsel.gif");
        JButton bdata = new JButton("Data", im);
//        bdata.setFont(bf);
        JButton bfunc = new JButton("Function", im);
//        bfunc.setFont(bf);
        bdata.setText(DrawPanelFrame.getLanguage(254, "Data"));
        bfunc.setText(DrawPanelFrame.getLanguage(255, "Function"));
        ...
        JButton bok = new JButton(DrawPanelFrame.getLanguage(3204, "OK"));
        JButton bcancel = new JButton(DrawPanelFrame.getLanguage("Cancel"));
        ...
        JMenu m = new JMenu(DrawPanelFrame.getLanguage(4015, "Coordinates"));
        mdata.add(m);
	...
	gxInstance.dp.getPointList(v);
        ...
        JMenuItem it = new JMenuItem(MathHelper.SPI);
        it.addActionListener(this);
        mdata.add(it);
        it = new JMenuItem(MathHelper.SE);
        it.addActionListener(this);
        mdata.add(it);

        mfunc = new JPopupMenu();
        for (int i = 0; i < MathHelper.sfunction.length; i++) {
            String s = MathHelper.sfunction[i];
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (command.equalsIgnoreCase("OK")) {
            if (text == null) {
                GEText tx = new GEText(0, 0, pane.getText());
