 ...
 */
public class DialogRectChooser extends DialogBase implements MouseListener, MouseMotionListener,
        MouseWheelListener, ActionListener {

    /**
	 * 
	 */
	private static final long serialVersionUID = -7960452331804577029L;
    ...
    public DialogRectChooser(DrawPanelFrame gx) {
        super(gx.getFrame(), true);
        this.setTitle(DrawPanelFrame.getLanguage(2300, " Please Choose The Client Area."));
        this.gxInstance = gx;
...
//        this.addWindowListener((new WindowDispose(this));
        ...
        bok = new JButton(DrawPanelFrame.getLanguage(3204, "OK"));
        bcancel = new JButton(DrawPanelFrame.getLanguage("Cancel"));
        bpane.add(bok);
        bpane.add(bcancel);
    ...
    class TextField extends JTextField {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -6246230973879303126L;
...
//            if (dm.getWidth() > 30)
    ...
    class drawPane extends JPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 3487912138496614856L;

		public drawPane() {
            this.addMouseListener(DialogRectChooser.this);
        }
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2.translate(-rx, -ry);
            if (gxInstance != null) {
                gxInstance.dp.paintPoint(g2);
                g2.setColor(Color.red);
                // g2.setStroke(CMisc.NormalLineStroke);
                g2.setStroke(UtilityMiscellaneous.DashedStroke1);
                if (Math.abs(rc.getWidth()) > 10 && Math.abs(rc.getHeight()) > 10) {
