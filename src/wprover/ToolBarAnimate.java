...
public class ToolBarAnimate extends JToolBar implements ActionListener, ChangeListener {

    /**
	 * 
	 */
	private static final long serialVersionUID = 7931693361618014315L;
	Timer timer;
    JSlider framesPerSecond;
    DrawPanelFrame expert;
    Animation ant;
    ...
    public ToolBarAnimate(DrawPanelFrame exp, JPanel pn, DrawPanel d) {
        ...
        it.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ToolBarAnimate.this.setVisible(false);
            }
        });
    ...
    public void setAttribute(Animation ant) {
        this.ant = ant;
        first = true;
    ...
    public int getSpeed() {
        return 1000 / framesPerSecond.getValue();
    }
