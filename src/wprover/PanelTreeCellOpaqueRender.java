...
public class PanelTreeCellOpaqueRender extends JPanel implements TreeCellRenderer, MouseListener {
    /**
	 * 
	 */
	private static final long serialVersionUID = -2010366067272043791L;
	static Icon Icon_etri = DrawPanelFrame.createImageIcon("images/dtree/etri.gif");
    static Icon Icon_squa = DrawPanelFrame.createImageIcon("images/dtree/squa.gif");
    static Icon Icon_perp = DrawPanelFrame.createImageIcon("images/dtree/perp.gif");
    static Icon Icon_parallelogram = DrawPanelFrame.createImageIcon("images/dtree/parallelogram.gif");


    private ArrayList<JLabel> vlist = new ArrayList<JLabel>();
    ...
    private DrawPanelFrame gxInstance = null;
    ...
    public PanelTreeCellOpaqueRender(DrawPanelFrame gx, boolean r) {
        this();
        gxInstance = gx;
        isRender = r;
    ...
    public PanelTreeCellOpaqueRender() {
...
//        }
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getButton() == MouseEvent.BUTTON3) {
            if (tree != null)
                ((TreeMProof) tree).showPopupMenu((JComponent) e.getSource(), e.getX(), e.getY());
        } /*else {
...
class TreeCellOPaqueEditor extends AbstractCellEditor implements TreeCellEditor {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4616547455784655679L;

	PanelTreeCellOpaqueRender render;

    DrawPanelFrame gxInstance;
    Object obj = null;
    JTree tree;

    public TreeCellOPaqueEditor(DrawPanelFrame gx) {
        gxInstance = gx;
        render = new PanelTreeCellOpaqueRender(gx, false);
    }
...
//    private Color backgroundNoSelectionColor = UIManager.getColor("Tree.textBackground");
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4987066554661271322L;
...
//                add(c2);
            ...
            case massertion.PARA_INSIDE: {
                ...
                this.add(c1);
                TreeCellOpaqueLabel c2 = this.getLabelByIndex(1);
                c2.setIcon(PanelTreeCellOpaqueRender.Icon_parallelogram);
                c2.setText(as.getShowString2());
                add(c2);
                break;
            }
...
/**
	 * 
	 */
	private static final long serialVersionUID = 379676716921268944L;
    ...
    public TreeCellOpaqueLabel() {
        ...
        this.setOpaque(false);
        this.setFont(UtilityMiscellaneous.manualFont);
