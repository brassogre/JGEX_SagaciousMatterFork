 ...
 */
public class FlashAngle extends Flash implements ActionListener {
    ...
    public FlashAngle(JPanel p, GEPoint p1, GEPoint p2, GEPoint p3, GEPoint p4) {
        super(p);
        timer = new Timer(TIME_INTERVAL, this);
        this.p1 = (p1);
        this.p2 = (p2);
    ...
    public boolean draw(Graphics2D g2) {
        if (n % 2 == 0) {
            g2.setColor(color);
            if (DrawPanelBase.check_para(p1, p2, p3, p4)) {
