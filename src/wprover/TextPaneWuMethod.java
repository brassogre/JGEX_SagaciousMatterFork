 ...
 */
public class TextPaneWuMethod extends JTextPane implements ActionListener {
    /**
	 * 
	 */
	private static final long serialVersionUID = -4619585393219740784L;
    ...
    protected void addStylesToDocument(StyledDocument doc) {
        ...
        Font defont = UtilityMiscellaneous.algebraFont;    //SansSerif
        ...
        ImageIcon pigIcon = DrawPanelFrame.createImageIcon("images/dtree/right.gif");
        if (pigIcon != null) {
            StyleConstants.setIcon(s, pigIcon);
        }
        s = doc.addStyle("icon2", regular);
        StyleConstants.setAlignment(s, StyleConstants.ALIGN_CENTER);
        pigIcon = DrawPanelFrame.createImageIcon("images/dtree/wrong.gif");
        if (pigIcon != null) {
            StyleConstants.setIcon(s, pigIcon);
        }
        s = doc.addStyle("icon3", regular);
        StyleConstants.setAlignment(s, StyleConstants.ALIGN_CENTER);
        pigIcon = DrawPanelFrame.createImageIcon("images/dtree/question.gif");
        if (pigIcon != null) {
            StyleConstants.setIcon(s, pigIcon);
        }
        s = doc.addStyle("icon4", regular);
        StyleConstants.setAlignment(s, StyleConstants.ALIGN_CENTER);
        pigIcon = DrawPanelFrame.createImageIcon("images/dtree/warn.gif");
        if (pigIcon != null) {
            StyleConstants.setIcon(s, pigIcon);
        }
